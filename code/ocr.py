...
def handle_invoice(message,bot):
	...
	if amount is not None:
		msg=bot.reply_to(message, f"OCR detected amount: {amount}\nIs this correct? (Yes/No)")
	else:
...
def post_category_selection(message, bot):
	try:
		...
		#message=amount
		message = bot.send_message(chat_id, f'Adding {amount} to category - {selected_category}'.format(str(option[chat_id])))
